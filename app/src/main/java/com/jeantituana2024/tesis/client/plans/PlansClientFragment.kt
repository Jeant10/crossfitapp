...
class PlansClientFragment : Fragment() {

    private lateinit var binding: FragmentPlansClientBinding
    private lateinit var userPreferences: UserPreferences
    private lateinit var tokenPreferences: TokenPreferences
    private lateinit var adapterPlanClient: AdapterPlanClient
    ...
    override fun onCreateView(
        ...
        binding = FragmentPlansClientBinding.inflate(inflater,container,false)
        return binding.root
    }
    ...
    private fun setupUI() {
        ...
        binding.searchEt.addTextChangedListener(object : TextWatcher {
            ...
            override fun onTextChanged(s: CharSequence?, start: Int, before: Int, count: Int) {
                try {
                    adapterPlanClient.filter.filter(s)
                } catch (e: Exception) {
                    e.printStackTrace()
                }
            }
            ...
            retrofitCall?.enqueue(object : Callback<PlansResponse> {
                override fun onResponse(call: Call<PlansResponse>, response: Response<PlansResponse>) {
                    ...
                    if (response.isSuccessful) {
                        ...
                        adapterPlanClient = AdapterPlanClient(requireContext(),planArrayList)
                        binding.plansRv.adapter = adapterPlanClient
