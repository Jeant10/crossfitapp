...
class DashboardCoachActivity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_dashboard_coach)
        ...
        if(savedInstanceState==null){
            openFragment(HomeCoachFragment())
    ...
    private fun navigateToLogin() {
        val intent = Intent(this@DashboardCoachActivity, LoginActivity::class.java)
    ...
    private fun navigateToProfile() {
        val intent = Intent(this@DashboardCoachActivity, ProfileActivity::class.java)
